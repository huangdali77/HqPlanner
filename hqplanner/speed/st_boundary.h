...
//   StBoundary::StBoundary(const hqplanner::speed::StBoundary& st_boundary)
//   {}
...
//   const double lower_left_delta_s = lower_points_[1].s() -
//   lower_points_[0].s(); const double upper_left_delta_s =
