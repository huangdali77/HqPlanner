...
//   const double adc_width = adc_param.width;
//   math::Box2d min_box({0, 0}, 1.0, 1.0, 1.0);
//   math::Box2d max_box({0, 0}, 1.0, 1.0, 1.0);
...
//     math::Vec2d center((first_point.x + second_point.x) / 2.0,
//                        (first_point.y + second_point.y) / 2.0);
//     math::Box2d object_moving_box(center, first_point.theta, total_length,
//                                   object_width);
...
//         std::hypot(trajectory_points[last_index].path_point.x -
//                        trajectory_points[i].path_point.x,
//                    trajectory_points[last_index].path_point.y -
...
//     double low_s = std::max(object_boundary.start_s() - adc_half_length,
//     0.0); bool has_low = false; double high_s =
